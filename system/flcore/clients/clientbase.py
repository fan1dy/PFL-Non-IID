...
class Client(object):
    ...
    def load_test_data(self, batch_size=None):
        if batch_size == None:
            batch_size = self.batch_size
        test_data, _ = read_client_data(self.dataset, self.id, is_train=False)
        return DataLoader(test_data, batch_size, drop_last=False, shuffle=True)

    def load_ref_data(self, batch_size=None):
        if batch_size == None:
            batch_size = self.batch_size
        _, ref_data = read_client_data(self.dataset, self.id, is_train=False)
        return DataLoader(ref_data, batch_size, drop_last=False, shuffle=True)
    ...
    def ref_metrics(self):
        ...
        return ref_acc, ref_num, bacc#, auc
